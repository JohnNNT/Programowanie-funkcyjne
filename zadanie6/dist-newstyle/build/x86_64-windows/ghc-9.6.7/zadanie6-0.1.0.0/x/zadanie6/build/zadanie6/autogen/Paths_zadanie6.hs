...
-- at runtime using the environment variable zadanie6_bindir.
...
-- environment variable zadanie6_libdir.
...
-- using the environment variable zadanie6_dynlibdir.
...
-- runtime using the environment variable zadanie6_datadir.
...
-- using the environment variable zadanie6_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\zadanie6-0.1.0.0-inplace-zadanie6"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\zadanie6-0.1.0.0"
libexecdir = "C:\\cabal\\zadanie6-0.1.0.0-inplace-zadanie6\\x86_64-windows-ghc-9.6.7\\zadanie6-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "zadanie6_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "zadanie6_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "zadanie6_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "zadanie6_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "zadanie6_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "zadanie6_sysconfdir") (\_ -> return sysconfdir)
