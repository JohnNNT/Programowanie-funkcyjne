...
-- at runtime using the environment variable zadanie7_bindir.
...
-- environment variable zadanie7_libdir.
...
-- using the environment variable zadanie7_dynlibdir.
...
-- runtime using the environment variable zadanie7_datadir.
...
-- using the environment variable zadanie7_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\zadanie7-0.1.0.0-inplace-zadanie7"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\zadanie7-0.1.0.0"
libexecdir = "C:\\cabal\\zadanie7-0.1.0.0-inplace-zadanie7\\x86_64-windows-ghc-9.6.7\\zadanie7-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "zadanie7_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "zadanie7_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "zadanie7_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "zadanie7_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "zadanie7_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "zadanie7_sysconfdir") (\_ -> return sysconfdir)
